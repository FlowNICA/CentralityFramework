...
public:
  ...
  std::unique_ptr<TH1F> GetModelHisto(const Float_t range[2], TString name,
                                      Int_t nEvents);
  ...
  TH2F GetBestNpart_VS_Multiplicity() const {
    return fBestNpart_VS_Multiplicity;
  }
  TH2F GetBestNcoll_VS_Multiplicity() const {
    return fBestNcoll_VS_Multiplicity;
  }
