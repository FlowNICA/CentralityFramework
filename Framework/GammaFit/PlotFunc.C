...
void SetStyle(TGraphErrors *const &gr, Color_t Color, const int MStyle, const char *YTitle = "fit/data", const char *XTitle = "N_{ch}", const int TextSize = 34, const double MarkSize = 1.5)
{
